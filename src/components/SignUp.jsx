    ...
    return (
        <div className="w-full max-w-lg mx-auto mt-16">
            ...
            <form className="bg-white shadow-md rounded px-8 mt-8 pt-6 pb-8 mb-4" onSubmit={handleSubmit(onSubmit)}>
                ...
                <input className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type='submit' value='Sign Up' />
            </form>
        </div>
